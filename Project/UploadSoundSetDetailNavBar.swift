...
extension UploadSoundSetDeatilsController{
    ...
    func setupNavigationBarItemList() {
        ...
        let sendButton = UIBarButtonItem(image:  #imageLiteral(resourceName: "Send").withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(startSend))
